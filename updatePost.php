<?php
	...
	$cmd = "UPDATE posts SET subcatid = '".$subcatid."', creatorid = '".$creatorid."', title = '".$title."', description = '".$description."', location = '".$locationid."', price = '".$price."', image1 = '".$image1."', image2 = '".$image2."', image3 = '".$image3."' WHERE postid = '".$postid."';";
