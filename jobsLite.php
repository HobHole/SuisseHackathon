...
echo '
	...
	<p class="textPointer" onclick="subCategory(\'fulltime\')" id="fulltime"><font size="6">full time</font></p>
	</div>
	
	<div style="position: absolute; top: 400px; left: 130px; width: 400px; font-weight: bold; color: white;">
	<p class="textPointer" onclick="subCategory(\'partTime\')" id="part time"><font size="6">part time</font></p>
	</div>
	
	<div style="position: absolute; top: 600px; left: 100px; width: 400px; font-weight: bold; color: white;">
	<p class="textPointer" onclick="subCategory(\'weekends\')" id="weekends only"><font size="6">weekends only</font></p>
	</div>';
